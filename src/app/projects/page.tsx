      ...
      <div className="projects">
        <div className="gallery-wrapper">
          ...
          <div className="buttons">
            ...
            >
              <p>{lang === "en" ? "Bathroom" : "Ванная комната"}</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="21"
                height="20"
        ...
        <div className="wrapper_360">
          <div className="title">
            <span className="title__left"></span>
            <h2 className="title__content">
              {lang === "en" ? "Project 360°" : "Проект 360°"}
            </h2>
            <span className="title__right"></span>
          </div>
          <div className="cards_360">
            <div className="card_360">
              ...
              >
                <p>
                  {lang === "en" ? "View project 360°" : "Просмотреть 360°"}
                </p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="21"
          ...
          <div className="process_wrapper_contents">
            ...
            <span className="content_texts">
              <div>
                <p>
                  {lang === "en"
                    ? en.Process.first.Title
                    : ru.Process.first.Title}
                </p>
                <p>
                  {lang === "en"
                    ? en.Process.first.Text
                    : ru.Process.first.Text}
                </p>
              </div>
              <div>
                <p>
                  {lang === "en"
                    ? en.Process.second.Title
                    : ru.Process.second.Title}
                </p>
                <p>
                  {lang === "en"
                    ? en.Process.second.Text
                    : ru.Process.second.Text}
                </p>
              </div>
              <div>
                <p>
                  {lang === "en"
                    ? en.Process.three.Title
                    : ru.Process.three.Title}
                </p>
                <p>
                  {lang === "en"
                    ? en.Process.three.Text
                    : ru.Process.three.Text}
                </p>
              </div>
            </span>

    ...
    return <div>
        {
            blog ? <div className="blog">
                <div className="blog__image-wrapper">
                    <Image className="blog__img" src={`https://admin.imaratgroup.uz/${blog.photo}`} alt="" width={680} height={500}/>
                    ...
                    <span className="blog__views-wrapper">
                        <span className="date">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="33" viewBox="0 0 32 33" fill="none">
                                <path d="M10.666 3.00124V7.00124" stroke="white" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M21.334 3.00124V7.00124" stroke="white" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M4.66602 12.4546H27.3327" stroke="white" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M28 11.6679V23.0012C28 27.0012 26 29.6679 21.3333 29.6679H10.6667C6 29.6679 4 27.0012 4 23.0012V11.6679C4 7.6679 6 5.00124 10.6667 5.00124H21.3333C26 5.00124 28 7.6679 28 11.6679Z" stroke="white" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M20.925 18.6013H20.9369" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M20.925 22.6013H20.9369" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M15.9914 18.6013H16.0034" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M15.9914 22.6013H16.0034" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M11.0597 18.6013H11.0717" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M11.0597 22.6013H11.0717" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            <p>{parseDate(blog.createdAt)}</p>
                        </span>
                        <span className="blog__views">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="33" viewBox="0 0 32 33" fill="none">
                            <path d="M20.7713 16.3346C20.7713 18.9746 18.6379 21.1079 15.9979 21.1079C13.3579 21.1079 11.2246 18.9746 11.2246 16.3346C11.2246 13.6946 13.3579 11.5612 15.9979 11.5612C18.6379 11.5612 20.7713 13.6946 20.7713 16.3346Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M15.9998 27.3612C20.7065 27.3612 25.0931 24.5879 28.1465 19.7879C29.3465 17.9079 29.3465 14.7479 28.1465 12.8679C25.0931 8.0679 20.7065 5.29457 15.9998 5.29457C11.2931 5.29457 6.90646 8.0679 3.85312 12.8679C2.65312 14.7479 2.65312 17.9079 3.85312 19.7879C6.90646 24.5879 11.2931 27.3612 15.9998 27.3612Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                            <p>{blog.views}</p>
                        </span>
                    </span>

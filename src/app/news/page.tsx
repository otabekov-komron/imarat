    ...
    <div className="news">
      <div className="blogs">
        <div className="title">
          ...
          <h2 className="title__content">{lang === "en" ? "Blog" : "Блог"}</h2>
        ...
        {blogs.length > end ? (
          <button onClick={() => setEnd(end + 6)} className="blog__view">
            <p>{lang === "en" ? "View more" : "Посмотреть больше"}</p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="23"
              height="22"
            ...
            {vacancies.map((item, index) => (
              ...
              >
                ...
                <svg
                  ...
                  fill="none"
                >
                  <g clipPath="url(#clip0_506_222)">
                    <path
                      d="M55.6299 27.1028L42.9029 14.3757C42.4457 13.8418 41.6423 13.7796 41.1084 14.2369C40.5746 14.6941 40.5123 15.4975 40.9696 16.0314C41.0123 16.0811 41.0587 16.1276 41.1084 16.1702L51.6591 26.7336H1.27267C0.569834 26.7336 0 27.3035 0 28.0064C0 28.7093 0.569834 29.2791 1.27267 29.2791H51.6591L41.1084 39.8297C40.5746 40.2869 40.5123 41.0904 40.9696 41.6242C41.4269 42.1581 42.2303 42.2203 42.7641 41.763C42.8139 41.7204 42.8604 41.674 42.9029 41.6242L55.63 28.8971C56.1234 28.4009 56.1234 27.5992 55.6299 27.1028Z"
                      fill="#1C1C1C"
                    />
                  </g>
                  <defs>
